...
class ChartGenerator:
    def __init__(self):
        ...
        with open(analysis_dir / '정서린_analysis.json', encoding='utf-8') as f:
    ...
    def generate_race_comparison(self, member_name='정서린'):
    ...
    def generate_race_opponents(self, member_name='정서린'):
    ...
    def generate_map_comparison(self, member_name='정서린'):
    ...
    def generate_map_opponents(self, member_name='정서린'):
    ...
    def generate_tier_comparison(self, member_name='정서린'):
    ...
    def generate_tier_opponents(self, member_name='정서린'):
    ...
    def generate_all_charts(self, member_name='정서린'):
        """모든 차트 생성"""
        ...
        print(f"\n{'=' * 80}")
        print("Step 3 완료: 차트 생성 성공")
        print(f"{'=' * 80}")
        print(f"\n생성된 차트 ({len([c for c in charts.values() if c is not None])}개):")
...
if __name__ == '__main__':
    ...
    charts = generator.generate_all_charts('정서린')
